import { ObservableObjectBase, createSignal } from '@tachui/core/minimal'
...
export class AppStateStore extends ObservableObjectBase {
  ...
  get tapeDisplay() {
    return this._tapeDisplaySignal[0]()
  }

  get tapeEntries() {
    return this._tapeEntriesSignal[0]()
  }
  ...
  toggleTape(): void {
    const currentValue = this._tapeDisplaySignal[0]()
