...
import { registerAsset, ColorAsset, ImageAsset, LinearGradient, StateGradient, createColorAsset } from '@tachui/core/minimal'
...
export function createCalculatorAssets() {
  // Images
  registerAsset(ImageAsset.init({ // TachUI logo with theme-appropriate variants
  ...
  registerAsset(ColorAsset.init({ // Orange logo text with reduced opacity in dark mode
  ...
  registerAsset(ColorAsset.init({ // Main calculator body background - white in light, dark gray in dark
  ...
  registerAsset(ColorAsset.init({ // Subtle border around calculator - light white/gray
  ...
  registerAsset(ColorAsset.init({ // Drop shadow for calculator depth - black with varying opacity
  ...
  // Display colors
  registerAsset(ColorAsset.init({ // Calculator display background - very subtle tint
  ...
  registerAsset(ColorAsset.init({ // Display text color - dark in light mode, light in dark mode
  ...
  registerAsset(ColorAsset.init({ // Number button background - light gray in light mode, darker gray in dark
  ...
  registerAsset(ColorAsset.init({ // Subtle border for number buttons - dark/light based on theme
    default: 'hsla(0, 0%, 0%, 0.05)',
    light: 'hsla(0, 0%, 0%, 0.05)',
    dark: 'hsla(0, 0%, 100%, 0.05)',
  ...
  registerAsset(ColorAsset.init({ // Number button text color - black in light, white in dark
    default: 'hsl(0, 0%, 0%)',
    light: 'hsl(0, 0%, 0%)',
    dark: 'hsl(0, 0%, 100%)',
  ...
  registerAsset(ColorAsset.init({ // Operator button background - signature orange color
  ...
  registerAsset(ColorAsset.init({ // Active/pressed operator button background - white/dark inversion
    default: 'hsl(0, 0%, 100%)',
    light: 'hsl(0, 0%, 100%)',
    dark: 'hsl(240, 3%, 11%)',
  ...
  registerAsset(ColorAsset.init({ // Operator button text color - white text on orange background
    default: 'hsl(0, 0%, 100%)',
    light: 'hsl(0, 0%, 100%)',
    dark: 'hsl(0, 0%, 0%)',
  ...
  registerAsset(ColorAsset.init({ // Active operator text color - orange when button is pressed/active
    default: 'hsl(35, 100%, 50%)',
    light: 'hsl(35, 100%, 50%)',
    dark: 'hsl(37, 100%, 52%)',
  ...
  registerAsset(ColorAsset.init({ // Function button background - medium gray for utility functions
    default: 'hsl(0, 0%, 65%)',
    light: 'hsl(0, 0%, 65%)',
    dark: 'hsl(240, 2%, 39%)',
  ...
  registerAsset(ColorAsset.init({ // Function button text color - black/white based on theme
    default: 'hsl(0, 0%, 0%)',
    light: 'hsl(0, 0%, 0%)',
    dark: 'hsl(0, 0%, 100%)',
  ...
  registerAsset('buttonGradientOverlay', StateGradient('buttonGradientOverlay', {
  ...
  registerAsset(createColorAsset( // App background gradient start - blue to dark purple
    'hsl(228, 76%, 67%)',         // Light mode: blue start
    'hsl(252, 58%, 26%)',         // Dark mode: dark purple start
    'appBackgroundStart'
  ))

  registerAsset(createColorAsset( // App background gradient end - purple to very dark
