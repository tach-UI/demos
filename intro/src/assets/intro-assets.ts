...
import { registerAsset, ColorAsset, LinearGradient, createGradientAsset, createGoogleFont } from '@tachui/core/minimal'
...
export function createIntroAssets() {
  ...
  registerAsset(createGradientAsset({
  ...
  // Font assets
  const baseFont = createGoogleFont(
    'Dosis',
  ...
  const logoFont = createGoogleFont(
    'Madimi One',
    [400],
    'logoFont',
    {
